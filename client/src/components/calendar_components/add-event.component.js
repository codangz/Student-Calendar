...
class AddEvent extends React.Component {
    ...
    */
    ...
    async handleAddEvent() {
        const r = (await EventService.createEvent(this.state.title, this.state.startDate, this.state.endDate, this.state.startTime, this.state.endTime, this.props.user.id, null))
        if (r.status === 200) {
